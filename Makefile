...
ifeq ("$(shell curl 'https://git.musl-libc.org/cgit/musl/plain/src/time/strptime.c' | sed  '/^#include <langinfo.h>/d; s/nl_langinfo\x28[^\x29]*\x29/""/;s/\<ABDAY_1\>/3/g;s/\<ABMON_1\>/2/g' >> src/strptime.c)","")
endif
