...
int reliq_match(const reliq_hnode *rqn, const reliq_node *node);
...
void reliq_printf(FILE *outfile, const char *format, const size_t formatl, const reliq_hnode *rqn, const char *reference);
